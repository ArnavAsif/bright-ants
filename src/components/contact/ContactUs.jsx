  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://bright-ants-backend.onrender.com/email",
        {
          method: "POST",
          headers: {
    ...
    >
      ...
      <div className="max-w-[1034px] mx-auto py-[96px] relative z-10">
        ...
        <p className="font-mulish lg:text-lg/[24px] tracking-[0%] text-center my-[10px]">
          Have a question or need a creative solution for your brand? We're here
          to help! Whether you're looking for graphic design, web development,
          UI/UX services, or digital media design, our team is ready to bring
          your vision to life. Fill out the contact form below or reach out
          directly—we'd love to hear from you! Let's create something amazing
          together.
        </p>
