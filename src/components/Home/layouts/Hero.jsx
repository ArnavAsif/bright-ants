...
const Hero = () => {
    ...
    return (
        ...
        <div className="mt-2 md:mt-[140px] max-w-[1344px] text-white overflow-hidden pt-16 pb-12 md:pb-40 px-5 lg:px-0  mx-auto flex flex-col-reverse lg:flex-row lg:justify-baseline items-center relative">
            ...
            {/* Ant Image (Desktop) */}
            <div className="flex overflow-hidden lg:scale-130 z-10 bg-[#1A191C] items-start lg:justify-start justify-end pr-5 lg:pr-14 max-w-[500px] w-full">
                <img
                    src={ant}
                    alt="Hero Ant"
                    className="w-[70%] lg:w-full h-auto scale-130 object-contain mix-blend-luminosity"
                />
            </div>
        </div>
