...
const ResourcesSection = () => {
    return (
        <section className="bg-[#0B0A29] text-white max-w-[1310px] mx-auto rounded-lg overflow-hidden my-[96px] md:my-[148px] px-5 sm:px-10 md:px-0">
                ...
                <div className="lg:w-1/2 md:pl-[60px] w-full">
                    ...
                    <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 md:flex md:gap-12 md:pl-0 gap-y-6 gap-x-8 justify-center md:justify-start max-w-xl mx-auto md:mx-0">
                        {[
                            ...
                            <div key={i} className="flex flex-col items-center md:items-start w-full sm:w-auto">
                                <div className="flex items-baseline gap-1">
                                    <p className="text-5xl sm:text-6xl font-extrabold leading-none">{number}</p>
