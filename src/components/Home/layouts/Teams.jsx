        ...
        <div className="w-full lg:w-[461px] lg:sticky lg:top-40 lg:self-start">
          <div className="max-w-[480px] w-full text-center lg:text-start mx-auto lg:mx-0">
            ...
            <p className="font-mulish text-[18px] md:text-[20px] xl:text-[22px] text-[#D8D8D8] mt-6 mb-8 leading-[28px] md:leading-[30px]">
              ...
              you can focus on your priorities while we manage the creative
              side.
            </p>
            <button
              onClick={() => {
        ...
        <section className="w-full lg:w-[725px]">
          {services.map((service, index) => (
            <Link key={index} to={service.link}>
              <div className="bg-[#1C1A1F] p-6 md:p-8 xl:p-10 rounded-lg shadow-[4px_4px_8px_rgba(0,0,0,0.25)] flex flex-col sm:flex-row gap-6 sm:gap-8 mb-[30px]">
                {/* Icon */}
