...
const Teams = () => {
  return (
    <div className="relative max-w-[1344px] mx-auto">
      <div className="relative w-full mx-auto py-16 px-4 md:px-10 xl:px-16 2xl:px-24 flex flex-col lg:flex-row gap-10 md:gap-16 z-20">
        ...
        <div className="w-full lg:w-1/2 lg:sticky lg:top-20 lg:self-start">
          <div className="max-w-[480px] w-full text-center lg:text-start mx-auto lg:mx-0">
            ...
            <p className="font-mulish text-[18px] md:text-[20px] xl:text-[22px] text-[#D8D8D8] mt-6 mb-8 leading-[28px] md:leading-[30px]">
              As your design partner, we offer tailored, cost-efficient design solutions — whether for ongoing support or specific projects — so you can focus on your priorities while we manage the creative side.
            </p>
            <button
              onClick={() => {
            ...
            <Link key={index} to={service.link}>
              <div className="bg-[#1C1A1F] p-6 md:p-8 xl:p-10 rounded-lg shadow-[4px_4px_8px_rgba(0,0,0,0.25)] flex flex-col sm:flex-row gap-6 sm:gap-8">
                ...
                <div className="w-[80px] flex justify-center items-start flex-shrink-0 mx-auto sm:mx-0">
                  <img src={service.icon} alt={service.title} className="w-full max-w-[80px]" />
                </div>
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-[10px] mt-4 justify-center sm:justify-start">
                    {service.items.map((item, i) => (
                      ...
                      >
                        <button
                          className="bg-[#262628] text-[#FAFAFA] text-[16px] md:text-[16px] xl:text-[18px] px-4 py-2 rounded-full font-mulish hover:bg-white hover:text-[#1C1A1F] transition-all duration-300"
                        >
                          {item}
                        </button>
                      </div>
