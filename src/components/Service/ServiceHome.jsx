...
const services = [
  {
    ...
    description:
      "At BrightAnts, we understand that design is more than just aesthetics - it's a powerful tool for communication. Our graphic design services combine creativity, innovation, and functionality to help your brand stand out, convey its message, and connect with its audience.",
    items: [
      "Logo design",
  ...
  },
  {
    ...
    description:
      "Great design isn't just about looks—it's about experience. At BrightAnts, we craft seamless, intuitive, and visually engaging user interfaces that enhance user journeys and drive engagement. Our UI/UX design process blends creativity with usability, ensuring your digital products are not only beautiful but also highly functional.",
    items: [
  ...
  },
  {
    ...
    description:
      "Powerful, flexible, and easy to manage—WordPress is the backbone of millions of websites worldwide. At BrightAnts, we specialize in crafting custom WordPress solutions that are fast, secure, and built to scale. Whether you need a brand-new site, a redesign, or ongoing support, we've got you covered.",
    items: [
    ...
    <div className="max-w-[1310px] mx-auto pt-[96px] pb-12 relative z-10 overflow-hidden">
              ...
              >
                ...
                <div className="flex justify-center items-start flex-shrink-0 mx-auto sm:mx-0">
                  <img
                    src={service.icon}
                    alt={service.title}
                    className="w-[200px] lg:w-[350px] max-w-full"
                  />
                </div>
                ...
                <div>
                  <div>
                    ...
                    <p className="pt-6 pb-12 text-center lg:text-start">
                      {service.description}
                    </p>
                  </div>
      ...
      <div className="hidden lg:block my-[148px]">
        ...
        <Marquee>
          <div className="flex">
            {images.map((image) => (
              <img
                className="w-full h-[389px] object-contain mr-[60px] "
      ...
      <div className="block lg:hidden my-[148px] px-5">
        ...
        <div className="flex flex-col gap-5">
          {images.map((image) => (
            <img
              className="w-full h-[389px] object-contain"
              src={`https://bright-ants-backend.onrender.com/files/${image.image}`}
            />
          ))}
        </div>
