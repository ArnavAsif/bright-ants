      ...
      <div className="relative z-10 flex flex-col-reverse lg:justify-between gap-[60px] lg:gap-0 lg:flex-row">
        <div className="lg:w-[740px]">
          ...
          <div className="text-center lg:text-start">
            <p>
              A great digital experience isn't just about aesthetics—it's about
              functionality, <br /> usability, and engagement. At BrightAnts, we
              craft intuitive and visually striking UI <br /> (User Interface)
              and UX (User Experience) designs that enhance user interactions
              and <br /> elevate your brand's digital presence. <br /> Our
              expert designers blend creativity with strategy, ensuring that
              every website, <br /> mobile app, or digital product we design is
              user-friendly, seamless, and impactful. We <br /> prioritize user
              needs, making sure your audience enjoys a smooth, engaging, and{" "}
              <br /> frustration-free experience.
            </p>
          </div>
