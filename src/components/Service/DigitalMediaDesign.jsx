        ...
        <div className='w-11/12 mx-auto pt-[96px] pb-12 relative z-10 overflow-hidden'>
            ...
            <div className='relative z-10 flex flex-col-reverse lg:justify-between gap-[60px] lg:gap-0 lg:flex-row'>
                <div className='lg:w-[740px]'>
                    <h1 className='text-center lg:text-start mb-6'>Digital Media Design</h1>
                    <div className='text-center lg:text-start'>
                        <p>In today's fast-paced digital world, your brand's online presence needs to be bold, <br /> engaging, and visually stunning. At BrightAnts, we specialize in Digital Media Design <br /> that helps businesses stand out across all digital platforms. Whether it's social media, <br /> websites, video content, or online advertising, we create eye-catching visuals that <br /> captivate audiences and drive engagement. <br />
                            Our approach combines creativity with strategy, ensuring that your brand not only <br /> looks great but also delivers results. Whether you're launching a campaign,<br /> promoting a product, or enhancing your brand's digital footprint, we bring ideas to <br /> life with powerful visual storytelling. <br />
                            Let's create digital experiences that leave a lasting impression!</p>
                    </div>
                ...
                <div className='flex justify-center items-center '>
                    <img className='w-[60%] lg:w-[437px] max-w-full object-cover' src={digital} alt="digital" />
                </div>
