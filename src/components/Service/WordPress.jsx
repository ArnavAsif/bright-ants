...
import ps from '../../assets/toolsWeuse/elementor.svg'
import ai from '../../assets/toolsWeuse/beaver.svg'
import lr from '../../assets/toolsWeuse/divi.svg'
import canva from '../../assets/toolsWeuse/seedprod.svg'
        ...
        <div className='max-w-[1310px] mx-auto pt-[96px] pb-12 relative z-10 overflow-hidden'>
            ...
            <div className='relative z-10 flex flex-col-reverse lg:justify-between gap-[60px] lg:gap-0 lg:flex-row'>
                <div className='lg:w-[740px]'>
                    <h1 className='text-center lg:text-start mb-6'>WordPress</h1>
                    <div className='text-center lg:text-start'>
                        <p>Powerful, flexible, and user-friendly—WordPress is the world's most popular content management system, trusted by businesses of all sizes. At BrightAnts, we specialize in creating custom WordPress solutions that are visually stunning, high-performing, and easy to manage. Whether you need a brand-new website, a custom theme, or ongoing support, our team ensures that your site is built for success.
                            With a strong focus on design, functionality, and performance, we craft WordPress websites that not only reflect your brand identity but also provide an exceptional user experience. Our expert developers use cutting-edge tools and best practices to ensure your website is secure, fast, and scalable.</p>
                    </div>
                ...
                <div className='flex justify-center items-center '>
                    <img className='w-[60%] lg:w-[437px] max-w-full object-cover' src={wordPress} alt="digital" />
                </div>
                ...
                <div className='max-w-[1075px] mx-auto'>
                    ...
                    <div className="grid grid-cols-2 lg:flex justify-center items-center gap-[30px] p-3 lg:p-0 lg:gap-6">
                        ...
                        <div className="flex items-center gap-5 relative lg:pr-[60px]">
                            ...
                            <p className='font-figtree font-normal text-[14px] md:text-[20px] leading-[120%] tracking-[-0.03em]'>Elementor</p>
                        ...
                        <div className="flex items-center gap-5 relative lg:px-[60px]">
                            ...
                            <p className='font-figtree font-normal text-[14px] md:text-[20px] leading-[120%] tracking-[-0.03em]'>Beaver <br /> Builder</p>
                        ...
                        <div className="flex items-center gap-5 relative lg:px-[60px]">
                            ...
                            <p className='font-figtree font-normal text-[14px] md:text-[20px] leading-[120%] tracking-[-0.03em]'>Divi</p>

                            {/* Divider */}
                            <div className="hidden lg:block absolute right-0 top-1/2 -translate-y-1/2 h-1/2 border-r-2 border-[#005DAA]"></div>
                        </div>

                        {/* SeedProd (no divider at the end) */}
                        <div className="flex items-center gap-5 lg:pl-[60px]">
                            <img src={canva} alt="canva" className="w-10 h-10 lg:w-20 lg:h-20" />
                            <p className='font-figtree font-normal text-[14px] md:text-[20px] leading-[120%] tracking-[-0.03em]'>SeedProd</p>
                        </div>
                    </div>
                </div>
            </div>
