      ...
      <div className="relative z-10 flex flex-col-reverse lg:justify-between gap-[60px] lg:gap-0 lg:flex-row">
        <div className="lg:w-[740px]">
          ...
          <div className="text-center lg:text-start">
            <p>
              Powerful, flexible, and user-friendly—WordPress is the world's
              most popular content management system, trusted by businesses of
              all sizes. At BrightAnts, we specialize in creating custom
              WordPress solutions that are visually stunning, high-performing,
              and easy to manage. Whether you need a brand-new website, a custom
              theme, or ongoing support, our team ensures that your site is
              built for success. With a strong focus on design, functionality,
              and performance, we craft WordPress websites that not only reflect
              your brand identity but also provide an exceptional user
              experience. Our expert developers use cutting-edge tools and best
              practices to ensure your website is secure, fast, and scalable.
            </p>
          </div>
