        ...
        <div className='w-11/12 mx-auto pt-[96px] pb-12 relative z-10 overflow-hidden'>
            ...
            <div className='relative z-10 flex flex-col-reverse lg:justify-between gap-[60px] lg:gap-0 lg:flex-row'>
                <div className='lg:w-[740px]'>
                    <h1 className='text-center lg:text-start mb-6'>Web Design</h1>
                    <div className='text-center lg:text-start'>
                        <p>Your website is the digital storefront of your brand—it should be visually compelling, <br /> easy to navigate, and designed to convert visitors into customers. At BrightAnts, we <br /> specialize in custom web design that blends creativity with functionality, ensuring <br /> your website not only looks stunning but also delivers an exceptional user experience. <br /> A great website isn't just about aesthetics—it's about performance, responsiveness, <br /> and usability. Whether you need a brand-new website, a redesign, or an optimized <br /> landing page, our expert designers craft sleek, modern, and engaging web <br /> experiences that align with your brand identity and business goals.</p>
                    </div>
                ...
                <div className='flex justify-center items-center '>
                    <img className='w-[60%] lg:w-[437px] max-w-full object-cover' src={web} alt="digital" />
                </div>
