      ...
      <div className="relative z-10 flex flex-col-reverse lg:justify-between gap-[60px] lg:gap-0 lg:flex-row">
        <div className="lg:w-[740px]">
          ...
          <div className="text-center lg:text-start">
            <p>
              Your website is the digital storefront of your brand—it should be
              visually compelling, <br /> easy to navigate, and designed to
              convert visitors into customers. At BrightAnts, we <br />{" "}
              specialize in custom web design that blends creativity with
              functionality, ensuring <br /> your website not only looks
              stunning but also delivers an exceptional user experience. <br />{" "}
              A great website isn't just about aesthetics—it's about
              performance, responsiveness, <br /> and usability. Whether you
              need a brand-new website, a redesign, or an optimized <br />{" "}
              landing page, our expert designers craft sleek, modern, and
              engaging web <br /> experiences that align with your brand
