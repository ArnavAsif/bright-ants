...
const Attorneys = () => {
    ...
    return (
        <div className="mb-[162px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 shadow-[4px_4px_8px_0_rgba(0,0,0,0.25)]">
                {
                    attorneys.map(attorney => 

                        <div key={attorney.id} className="flex flex-col justify-center items-center mt-[30px] p-5">
                            <div>
                                <img className="w-[318px] h-[364px] max-w-full rounded-t-[20px] object-cover bg-[#d8d8d8] mb-[21px]" src={`${API}/files/${attorney.image}`} alt="attorney" />
                            </div>
                            <h3>{attorney.name}</h3>
